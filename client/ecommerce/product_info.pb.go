...
type Product struct {
	...
	Price         float32                `protobuf:"fixed32,4,opt,name=price,proto3" json:"price,omitempty"` // добавьте, если есть в книге
...
const file_product_info_proto_rawDesc = "" +
	...
	"\n" +
	"getProduct\x12\x14.ecommerce.ProductID\x1a\x12.ecommerce.ProductB)Z'productinfo/service/ecommerce;ecommerceb\x06proto3"
