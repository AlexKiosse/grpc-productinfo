...
const file_ecommerce_order_management_proto_rawDesc = "" +
	"\n" +
	" ecommerce/order_management.proto\x12\tecommerce\x1a\x1egoogle/protobuf/wrappers.proto\"\x87\x01\n" +
	"\x05Order\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05items\x18\x02 \x03(\tR\x05items\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x14\n" +
	"\x05price\x18\x04 \x01(\x02R\x05price\x12 \n" +
	"\vdestination\x18\x05 \x01(\tR\vdestination\"j\n" +
	"\x10CombinedShipment\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\x12.\n" +
	"\torderList\x18\x03 \x03(\v2\x10.ecommerce.OrderR\torderList2\xa1\x02\n" +
	...
	"\rprocessOrders\x12\x1c.google.protobuf.StringValue\x1a\x1b.ecommerce.CombinedShipment(\x010\x01B)Z'productinfo/service/ecommerce;ecommerceb\x06proto3"

var (
	file_ecommerce_order_management_proto_rawDescOnce sync.Once
	file_ecommerce_order_management_proto_rawDescData []byte
)

func file_ecommerce_order_management_proto_rawDescGZIP() []byte {
	file_ecommerce_order_management_proto_rawDescOnce.Do(func() {
		file_ecommerce_order_management_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ecommerce_order_management_proto_rawDesc), len(file_ecommerce_order_management_proto_rawDesc)))
	})
...
var file_ecommerce_order_management_proto_goTypes = []any{
...
func file_ecommerce_order_management_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ecommerce_order_management_proto_rawDesc), len(file_ecommerce_order_management_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
